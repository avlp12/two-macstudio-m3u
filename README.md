...
> **DeepSeek-V4-Flash-0731, 4-bit, served across both boxes: prefill 895 tok/s on a 13.9K-token
> prompt (TTFT 15.5 s), decode 45–47 tok/s single-stream / 112–117 tok/s aggregate at batch 8.**
